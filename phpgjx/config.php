...
[mysqld]
general_log=ON
general_log_file=D:/phpstudy/PHPTutorial/WWW/thinkphpGo/phpgjx/log/sql.log // 这里设置你 log日志路径  这个配置下面数组配置需要用得上
...
*/
return array(
	'web_url'  =>'http://sql.sql.sql/index.php', // php工具箱访问 url 根路径  能访问到你工具箱的 地址
	'mysql_log'=>'D:/phpstudy/PHPTutorial/WWW/thinkphpGo/phpgjx/log/sql.log', // mysql 标准日志文件路径
